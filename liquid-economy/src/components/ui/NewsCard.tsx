...
export default function NewsCard({ story }: Props) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col h-full bg-[var(--color-surface-container-lowest)] rounded-2xl p-5 border border-[var(--color-outline-variant)]/25 hover:shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
    >
